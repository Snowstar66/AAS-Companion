...
describe("Delivery type guidance", () => {
  it("updates helper and guidance text immediately when the selection changes", () => {
    ...
    expect(
      screen.getByText(
        "Application Transformation: What in the current system is blocking value? In this mode, Framing should emphasize outcome, baseline, risk posture, and ai level need tighter discipline."
      )
    ).toBeDefined();
    expect(
      screen.getByText(
